        ...
        {selectedDivision === 'grade4' && (
          <div className="flex justify-center">
            <svg viewBox="0 0 500 400" className="max-w-lg w-full">
              {/* Square shape */}
              <line x1="150" y1="80" x2="350" y2="80" stroke="#DC2626" strokeWidth="2" />
              <line x1="350" y1="80" x2="350" y2="280" stroke="#DC2626" strokeWidth="2" />
              <line x1="350" y1="280" x2="150" y2="280" stroke="#DC2626" strokeWidth="2" />
              <line x1="150" y1="280" x2="150" y2="80" stroke="#DC2626" strokeWidth="2" />
              ...
              <text x="315" y="125" className="fill-gray-500 text-xs">(2)</text>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <svg viewBox="0 0 400 300" className="max-w-sm w-full">
                  {/* Square shape */}
                  <line x1="100" y1="60" x2="300" y2="60" stroke="#DC2626" strokeWidth="2" />
                  <line x1="300" y1="60" x2="300" y2="240" stroke="#DC2626" strokeWidth="2" />
                  <line x1="300" y1="240" x2="100" y2="240" stroke="#DC2626" strokeWidth="2" />
                  <line x1="100" y1="240" x2="100" y2="60" stroke="#DC2626" strokeWidth="2" />
                  ...
                  <text x="265" y="105" className="fill-gray-500 text-xs">(7)</text>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <svg viewBox="0 0 400 300" className="max-w-sm w-full">
                  ...
                  <text x="265" y="105" className="fill-gray-500 text-xs">(8)</text>
              ...
              <div className="flex flex-col items-center">
                ...
                <svg viewBox="0 0 400 300" className="max-w-sm w-full">
                  ...
                  <text x="265" y="105" className="fill-gray-500 text-xs">(20)</text>
