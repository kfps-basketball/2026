    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="flex items-center justify-center">
          <a
            href={`${import.meta.env.BASE_URL}2026_kfcup_cover.jpg`}
            target="_blank"
            rel="noopener noreferrer"
            className="cursor-pointer"
          >
            <img
              src={`${import.meta.env.BASE_URL}2026_kfcup_cover.jpg`}
              alt="2026光復盃籃球邀請賽"
              className="w-auto h-auto lg:max-h-[500px] rounded-lg shadow-lg hover:shadow-xl transition-shadow"
            />
          </a>
        </div>
      </div>
